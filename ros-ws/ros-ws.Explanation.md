...
To make the already existing file compatable with MoveIt2, put this command "ros2 launch moveit_setup_assistant setup_assistant.launch.py" in terminal after sourcing to get a setup file make this process simple.
To launch the Moveit2 file run "ros2 launch panda_moveit_config demo.launch.py" in terminal after sourcing.
