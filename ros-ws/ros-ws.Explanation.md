First install ROS2 and MoveIt2 from the given link before starting.<br/>  <br/> 
...
So to run each urdf file, i made seperate launch.py file to simulate in Rviz2. One launch.py file and one controller.yaml for each urdf.xacro file.<br/>  <br/> 
...
- Finally run "run_sequence.py" in seperate terminal if you want to want to run the robotic arm in pre planned sequence. This also work even when Arduino is not connected.<br/>  <br/> 
